...
require (
	...
	github.com/ollama/ollama v0.5.6
...
require (
	...
	buf.build/gen/go/interplex-ai/schemas/protocolbuffers/go v1.36.3-20241117203254-a91193b62179.1
	...
	buf.build/gen/go/k8sgpt-ai/k8sgpt/protocolbuffers/go v1.36.3-20241118152629-1379a5a1889d.1
